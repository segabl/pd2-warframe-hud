Hooks:PostHook(HUDPlayerDowned, "init", "init_wfhud", function (self)
	...
	self._hud.timer:set_font_size(WFHud.font_sizes.default)
	self._hud.timer:set_h(WFHud.font_sizes.default)
	self._hud.timer:set_top(timer_msg:bottom())

	self._hud.arrest_finished_text:set_font(WFHud.font_ids.default)
	self._hud.arrest_finished_text:set_font_size(WFHud.font_sizes.default)
	self._hud.arrest_finished_text:set_h(WFHud.font_sizes.default)
